/*
* Problem #45
* Write a program to read bank clinet data record and convert it to one line
*/
#include <iostream>
#include <cmath>
#include <string>
...
string ConvertClientDataToString(stClient client)
{
    ...
    ClientData += Deleimeter + client.PinCode ;
    ClientData += Deleimeter + client.Name;
    ClientData += Deleimeter + client.Phone;
    ClientData += Deleimeter + to_string(client.AccountBalance);
...
int main()
{
    ...
    cout << ConvertClientDataToString(ReadNewClient());
