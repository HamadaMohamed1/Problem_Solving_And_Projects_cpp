/*
* Problem #12
* Write a program to check two 3x3 matrices if they are typical or not
*/
#include <iostream>
#include <cmath>
#include <string>
...
bool IsTypical(int arr1[3][3], int arr2[3][3])
{
    short i, j;
    for (i = 0; i < 3; i++)
    {
...
int main()
{
    ...
    if (IsTypical(matrix1, matrix2))
    {
        cout << "2 matrcies are Typical" << endl;
    }
    else
    {
        cout << "2 matrcies are Not Typical" << endl;
    }
