/*
* Problem #32
* Write a program to read a string and read a character and check if it is a vowel or not
*/
#include <iostream>
#include <cmath>
#include <string>
...
int main()
{
    ...
    char my_ch = ReadCharacter("Enter a character");
   
    if (CharIsVowel(my_ch))
    {
        cout << my_ch << "  is vowel" << endl;
    }
    else
    {
        cout << my_ch << "  is not vowel" << endl;
    }
