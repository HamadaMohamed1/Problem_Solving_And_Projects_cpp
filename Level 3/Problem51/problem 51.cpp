/*
* Problem #51
* Write a program to Update cleint info by account number 
*/
#include <iostream>
#include <cmath>
#include <string>
...
void DeleteClientInFile(string FileName, string AccountNumber)
{
    char ch;
    vector <string> vect;
...
void UpdateClientInFile(string FileName, string AccountNumber)
{
    char ch;
    vector <string> vect;
    string client_string;
...
int main()
{
   ...
   // ReadClientsAndSaveThemIntoFile("Clients.txt");
    ...
    PrintClientData(FindClientInFile("Clients.txt" , "A10"));
    //DeleteClientInFile("Clients.txt" , "456789");

    //UpdateClientInFile("Clients.txt", "A10");
