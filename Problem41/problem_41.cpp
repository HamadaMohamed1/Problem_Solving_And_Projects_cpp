/*
Write a program to fill array with numbers ,then check if it palindrome array or not
*/
#include <iostream>
using namespace std;
...
int main()
{
    ...
    string str = is_palindrome_array(arr, length) ? "Yes array is palinderome" : "No array is not palinderome";
    cout << str;
