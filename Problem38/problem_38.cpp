...
then copy only the odd numbers another array using add_array_element and print the 2 arrays
*/
#include <iostream>
using namespace std;
...
int main()
{
    ...
    dest_length = copy_odd_numbers_in_array(source, destination, src_length);
