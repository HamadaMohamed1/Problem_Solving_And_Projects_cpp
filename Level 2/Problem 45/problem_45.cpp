/*
Write a program to fill array with random numbers from -100 to 100 , with max size = 100 ,
then print the count of nigative numbers of that array
*/
#include <iostream>
using namespace std;
...
int main()
{
    ...
    fill_array_in_range(arr, length, -100, 100);
    print_array(arr, length);
    cout << "The count of nigative numbers : " << count_of_nigative_numbers_in_array(arr, length) << endl;
