/*
Write a program to fill array with numbers ,then print distnict numbers to another array
*/
#include <iostream>
using namespace std;
...
int main()
{
    ...
    int destination[100];
    int src_length=10, dest_length=0;
    int source[10] = {10,10,10,20,20,30,30,50,70,50};
    dest_length = copy_distnict_numbers_in_array(source, destination, src_length);
