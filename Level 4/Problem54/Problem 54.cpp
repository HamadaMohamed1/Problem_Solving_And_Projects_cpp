/*
* Problem #54
* Write a program to calculate the actual vacation days
*/
...
int main()
{
    ...
    stdate vacation_to = ReadDate();

    cout << "vacation from : " << DayShortName(DayOfWeekOrder(vacation_from)) <<"  ";
    PrintDate(vacation_from);

    cout << "vacation to   : " << DayShortName(DayOfWeekOrder(vacation_to)) << "  ";
    PrintDate(vacation_to);

    cout << "Actual Vacation Days : " << ActualVacationDays(vacation_from , vacation_to) << endl;
