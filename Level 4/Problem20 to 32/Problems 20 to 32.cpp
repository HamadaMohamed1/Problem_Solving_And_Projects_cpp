/*
* Problems #20 to #32
* Write a program to perform some functions {IncreaseDateBy1Day , IncreaseDateByXDays ,IncreaseDateBy1Month, IncreaseDateByXMonth ...etc}
*/
...
int main()
{
    ...
    PrintDate(date);
    cout << "IncreaseDateBy 1 Day : "; 
    date = IncreaseDateBy1Day(date);
    PrintDate(date);

    cout << "IncreaseDateBy 10 Days : ";
    date = IncreaseDateByXDays(date , 10);
    PrintDate(date);

    cout << "IncreaseDateBy 1 Week : ";
    date = IncreaseDateBy1Week(date);
    PrintDate(date);

    cout << "IncreaseDateBy 10 Weeks : ";
    date = IncreaseDateByXWeeks(date , 10);
    PrintDate(date);

    cout << "IncreaseDateBy 1 Month : ";
    date = IncreaseDateBy1Month(date);
    PrintDate(date);

    cout << "IncreaseDateBy 5 Month : ";
    date = IncreaseDateByXMonth(date, 5);
    PrintDate(date);

    cout << "IncreaseDateBy 1 Year : ";
    date = IncreaseDateBy1Year(date);
    PrintDate(date);

    cout << "IncreaseDateBy 10 Year : ";
    date = IncreaseDateByXYear(date, 10);
    PrintDate(date);/**/

    cout << "IncreaseDateBy 1 Decade : ";
    date = IncreaseDateBy1Decade(date);
    PrintDate(date);

    cout << "IncreaseDateBy 10 Decade : ";
    date = IncreaseDateByXDecade(date, 10);
    PrintDate(date);/**/

    cout << "IncreaseDateBy 1 Century : ";
    date = IncreaseDateBy1Century(date);
    PrintDate(date);

    cout << "IncreaseDateBy 1 Millennium : ";
