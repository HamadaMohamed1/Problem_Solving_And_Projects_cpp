/*
* Problem #33 to 46
* Write a program to perform some functions {DecreaseDateBy1Day , DecreaseDateByXDays ,DecreaseDateBy1Month, DecreaseDateByXMonth ...etc}
*/
...
int main()
{
    ...
    PrintDate(date);
    cout << "DecreaseDateBy 1 Day : "; 
    date = DecreaseDateBy1Day(date);
    PrintDate(date);

    cout << "DecreaseDateBy 10 Days : ";
    date = DecreaseDateByXDays(date , 10);
    PrintDate(date);

    cout << "DecreaseDateBy 1 Week : ";
    date = DecreaseDateBy1Week(date);
    PrintDate(date);

    cout << "DecreaseDateBy 10 Weeks : ";
    date = DecreaseDateByXWeeks(date , 10);
    PrintDate(date);

    cout << "DecreaseDateBy 1 Month : ";
    date = DecreaseDateBy1Month(date);
    PrintDate(date);

    cout << "DecreaseDateBy 5 Month : ";
    date = DecreaseDateByXMonth(date, 5);
    PrintDate(date);

    cout << "DecreaseDateBy 1 Year : ";
    date = DecreaseDateBy1Year(date);
    PrintDate(date);

    cout << "DecreaseDateBy 10 Year : ";
    date = DecreaseDateByXYear(date, 10);
    PrintDate(date);/**/

    cout << "DecreaseDateBy 1 Decade : ";
    date = DecreaseDateBy1Decade(date);
    PrintDate(date);

    cout << "DecreaseDateBy 10 Decade : ";
    date = DecreaseDateByXDecade(date, 10);
    PrintDate(date);/**/

    cout << "DecreaseDateBy 1 Century : ";
    date = DecreaseDateBy1Century(date);
    PrintDate(date);

    cout << "DecreaseDateBy 1 Millennium : ";
