/*
* Problem #13
* Write a program to check if the date 1 less than date 2 or not 
*/
#include <iostream>
#include <string>
using namespace std;
...
int main()
{
    ...
    cout << "Enter 2nd date" << endl;
     day = (short)ReadNumber("Enter the day");
     month = (short)ReadNumber("Enter the month");
     year = (short)ReadNumber("Enter the year");
    stdate date2 = { date2.year = year , date2.month = month , date2.day = day };

    if (CompareTwoDates(date1, date2))
    {
        cout << "date2 lessthan date1" << endl;
    }
    else
    {
        cout << "date1 lessthan date2" << endl;
    }
