/*
* Problem #56
* Write a program to read 2 dates and check if date 1 is after date2 or not
*/
...
{
    return ((date1.day > date2.day) ? true : (date1.month > date2.month) ? true : (date1.year > date2.year) ? true : false);
}
