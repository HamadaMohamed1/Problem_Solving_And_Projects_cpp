/*
* Problem #58
* Write a program to read 2 periods and check if overlaps or not
*/
...
{
    /*Return : -1 Before , 0 Equals , 1 After*/
    short ret = -2;
    ...
    else if (IsTwoDatesEquals(date1 , date2))
    {
        ret = 0;
    }
...
int main()
{
    ...
    cout << "Period 1 start " << endl;
    stdate date1 = ReadDate();
    cout << "Period 1 end " << endl;
    stdate date2 = ReadDate();

    period1.start = date1;
    period1.end = date2;

    cout << "Period 2 start " << endl;
    date1 = ReadDate();
    cout << "Period 2 end " << endl;
    date2 = ReadDate();

    period2.start = date1;
    period2.end = date2;

    cout << "\nIsOverlapPeriods : " << IsOverlapPeriods(period1 , period2);
