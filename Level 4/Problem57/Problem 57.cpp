/*
* Problem #57
* Write a program to read 2 dates and compare them 
*/
...
int main()
{
    ...
    short result = CompareDates(date1, date2);
    if (result == -1)
    {
        cout << "\nDate1 Before Date2" << endl;
    }
    else if (result == 0)
    {
        cout << "\nDate1 Equal Date2" << endl;
    }
    else if (result == 1)
    {
        cout << "\nDate1 After Date2" << endl;
    }
